...
import { addProductSchema } from '../table/config/shemas'
import {
    Form,
    FormControl,
    FormField,
...
type AddFormValues = zodInfer<typeof addProductSchema>
...
export const AddProduct = () => {
    ...
    const HandleAddProduct = (data: AddFormValues) => {
        console.log(data)
    ...
    return (
        <div>
            <Dialog
                ...
                <DialogContent className='border-[1.5px] border-sidebar-primary-foreground bg-[#e7dbcf] sm:max-w-[425px]'>
                    <DialogHeader>
                        <DialogTitle>Add your own new product!</DialogTitle>
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    type='number'
                                                    placeholder='A lot $'
                                                    className='w-[180px] border border-yellow-800/30 bg-white/60'
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage />
